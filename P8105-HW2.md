...
```
    ...
    ##  1 ""    A              4        25 Charity worker               Saltley, Birmi…
    ##  2 ""    A             10        28 Geography teacher            Essex          
    ##  3 ""    A              6        37 Nurse                        Bracknell, Ber…
    ##  4 ""    A             10        24 Fashion designer             Halifax        
    ##  5 ""    A              7        25 Aerospace engineer           Derby / Holywo…
    ##  6 ""    A              1        30 Midwife                      Essex          
    ##  7 ""    A              9        30 Banker                       London         
    ##  8 ""    B              4        31 Military Wives' Choir Singer Aldershot, Ham…
    ##  9 ""    B              2        31 Graphic Designer             Northampton    
    ## 10 ""    B              7        23 Teaching assistant           South London   
    ## # ℹ 110 more rows
